...
BPF_ARRAY(weights, uint32_t, __MAX_CPU__);
...
weights = b.get_table("weights")
weights[0] = ct.c_uint32(1)  # CPU 0 的权重为 1
weights[1] = ct.c_uint32(2)  # CPU 1 的权重为 2
# 可以根据实际情况设置其他 CPU 的权重
