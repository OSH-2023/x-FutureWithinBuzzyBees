...
| 6.15 | 考前总结  | 期末考前最后一次例会，讨论了考前的准备工作，以及考后的项目进展 |    TO BE DONE          |
| 6.16～7.5 | 考试周  | 期末考试，考试结束后讨论了考试的情况，以及接下来的项目进展 |     TO BE DONE         |
| 7.6 | 考后总结 | 期末考试后的第一次例会，讨论了考试的情况，以及接下来的项目进展 |     TO BE DONE         |
