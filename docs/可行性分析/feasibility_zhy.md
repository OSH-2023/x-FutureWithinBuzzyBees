...
1. docker build——编译dockerfile
   ...
   ![image-20230422180911243](feasibility_zhy.assets/image-20230422180911243.png)

2. docker run

   docker daemon接收到该命令后找到具体的image，加载到内存开始执行。

   ![image-20230422181040426](feasibility_zhy.assets/image-20230422181040426.png)

3. docker pull

   docker daemon接收该命令后向docker registry发送下载image，从公共仓库Docker Hub下载公共image。

   ![image-20230422181255495](feasibility_zhy.assets/image-20230422181255495.png)
