- [Analysis of Feasibility](#analysis-of-feasibility)
  - [技术依据](#技术依据)
    ...
    - [2 DMA based on eBPF](#2-dma-based-on-ebpf)
      - [使用eBPF与XDP技术实现一个兼备DMA能力的内核](#使用ebpf与xdp技术实现一个兼备dma能力的内核)
...
- 前景和可行性：DMA 技术的应用前景广阔，但需要一定的硬件和软件支持；实现 DMA 技术需要一定的硬件和编程经验，但相对来说比较可行。
...
考虑到项目可行性，我们没有选择kernel-bypass,考虑到性能优化以及对大文件IO性能的需求我们选择了DMA.
